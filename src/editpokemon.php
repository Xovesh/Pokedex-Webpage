    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid top">
            <div class="bg-light pad">
                <form action="phpscripts/pokedex/editpokemon.php" method="post">
                    <h3>Editar pokemon</h3>
                    <div class="row">
			<?php require("phpscripts/pokedex/editpokemonform.php"); ?>
                    </div>
                    <hr>
                    <button type="reset" class="btn btn-danger">Restaurar campos</button>
                    <button type="submit" class="btn btn-warning">Actualizar pokemon</button>
                </form>
            </div>
        </div>
        <!-- contenido fin -->
