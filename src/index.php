...
<div class="container">
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid top">
            <div class="bg-light pad" style="text-align:center; font-size:2em;">
                <h3><?php if(isset($_SESSION['user'])){
                            echo 'Tu lista de favoritos'; 
                          }else{
                            echo 'Pokemon del día';                                                 
                          }
                    ?>
                </h3>
            </div>
            <div class="bg-light pad">
                <?php require("phpscripts/other/indexcontent.php");?>
                <br>
            </div>
        </div>
        <!-- contenido fin -->
