		...
		if ($pok['id'] == $num){
			...
			echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="'.$pokup->pokedex_number.'" class="form-control" name="pokedex_number"
                                       id="pokedex_number">
                            </div>
                        </div>');
                        echo('<div class="col-6">
					...
					for($i=1; $i<=7; $i++){
    						if ($i == $pokup->generation){
							echo('<option selected value="'.$i.'">Generación'.$i.'</option>');
						}else{
							echo('<option value="'.$i.'">Generación'.$i.'</option>');
						}
					}
                                  echo('</select>
                            </div>
					...
					if (0 == $pokup->legendary){
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" value="'.$pokup->name.'" name="name" id="name"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" value="'.$pokup->jp_name.'" name="name_jp" id="name_jp"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="0" required class="form-control" value="'.$pokup->weight_kg.'" name="weight" id="weight"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="any"  min="0" required class="form-control" value="'.$pokup->height_m.'" name="height" id="height"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="-1" class="form-control" value="'.$pokup->male_percentage.'" name="male_percentage" id="male_percentage"
					...
					foreach ($type as &$tipo){
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
								...
								foreach ($array as &$class){
                                    if (strcmp($class, $pokup->classification) == 0){
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="0" required class="form-control" value="'.$pokup->capture_rate.'" name="capture_rate" id="capture_rate"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" required class="form-control" value="'.$pokup->base_egg_steps.'" name="base_egg_steps"
                                       id="base_egg_steps"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" min="0" required class="form-control" value="'.$pokup->abilities.'" name="abilities"
                                       id="abilities"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" required class="form-control" value="'.$pokup->experience_growth.'" name="experience_growth"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" required class="form-control" value="'.$pokup->base_happiness.'" name="base_happiness"
                                       id="base_happiness"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" onchange="calcular_total();" required class="form-control" value="'.$pokup->hp.'" name="hp" id="hp"
                                       placeholder="Vida">
                            </div>
                        </div>');
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" onchange="calcular_total();" class="form-control" value="'.$pokup->attack.'" name="attack" id="attack"
                                       placeholder="Ataque">
                            </div>
                        </div>');
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" onchange="calcular_total();" class="form-control" value="'.$pokup->defense.'" name="sp_attack" id="sp_attack"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" onchange="calcular_total();" class="form-control" value="'.$pokup->sp_attack.'" name="defense" id="defense"
                                       placeholder="Defensa">
                            </div>
                        </div>');
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" onchange="calcular_total();" required class="form-control" value="'.$pokup->sp_defense.'" name="sp_defense" id="sp_defense"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" onchange="calcular_total();" required class="form-control" value="'.$pokup->speed.'" name="speed" id="speed"
                        ...
                        echo('<div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" disabled required class="form-control" value="'.$pokup->base_total.'" name="base_total" id="base_total"
                                       placeholder="Total">
                            </div>
                        </div>');
                        echo('<div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" value="'.$pokup->picture_local.'" name="localimage" id="localimage"
                        ...
                        echo('<div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="url" required class="form-control" value="'.$pokup->picture_web.'" name="internetimage" id="internetimage"
                                       placeholder="Link de la imagen (internet)">
                            </div>
                       </div><input type="hidden" value="'.$num.'" name="id">');
