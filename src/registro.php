<?php session_start(); 		if(isset($_SESSION['privilege'])){
					echo "<script>
...
<head>
    ...
    <script src="js/ShowUbication.js"></script>
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid top">
            <div class="login bg-light pad">
                <form action="phpscripts/users/register.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="password" required class="form-control" name="passwordrepeat"
                                       id="passwordrepeat"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                             ...
                             <button type="button" class="btn btn-secondary btn-sm" onclick="getLocation()">Usar Ubicación Actual</button>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                    ...
                    <hr>
                    <span class="help-block">Si te registras aceptas nuestras
                            <a href="#"
                               onclick="window.open('data/other/terms_of_service.pdf', '_blank', 'fullscreen=yes'); return false;"> condiciones de servicio </a>
                        </span>
                        <div id="ubication"></div>
                    <hr>
