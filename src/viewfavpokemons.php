    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid top">
            <div class="bg-light pad">
                <h3>Ver mis pokemons favoritos</h3>
                <div class="table-responsive">
                    <table id="pokemonteams" class="table table-bordered table-hover">
			<thead>
                        <tr>
                        ...
                        <tbody>
				<?php require("phpscripts/pokemonteam/viewfavpokemon.php"); ?>
			</tbody>
                    </table>
                </div>
            </div>
